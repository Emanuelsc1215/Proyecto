...
const Admin = () => {
  ...
  return (
    <div className='absolute bg-white py-4 top-10 w-[95%] left-[2%] border-2 border-blue-500 z-20 h-[90%] rounded-lg overflow-auto'>
           ...
           <div class="w-full bg-white rounded-lg md:mt-0 sm:max-w-md xl:p-0">
            ...
            <p class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">
              ...
              <label class="block mb-2 text-sm font-medium text-gray-900">
                ...
                placeholder="JohnDoe" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" id="username" />
              </div>
              <div>
                <label class="block mb-2 text-sm font-medium text-gray-900">
                  Usuario
              ...
              <div className='flex items-start'>
                ...
                <input class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-30 focus:ring-primary-600 ring-offset-gray-800" type="checkbox" aria-describedby="terms" id="terms" />
                </div>
                <div class="ml-3 text-sm">
                  <label class="font-light text-gray-500 ">
                    Usted Acepta Los
                    <a href="#" class="font-medium hover:underline text-primary-500">
          ...
          Editar?
          <div>
          <button onClick={update}  class="w-full bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center   text-white">Actualizar</button> 
          <button onClick={LimpiarCampos}  class="w-full bg-blue-500 hover:bg-primary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 top-4 relative text-center   text-white">Cancelar</button>
          </div>
